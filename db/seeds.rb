...
wijetunga = Family.create(name: 'Wijetunga', members: "Anna Sachith")
lipshutz = Family.create(name: 'Lipshutz', members: "Randi Drew")
tattan = Family.create(name: 'Tattan', members: "David")
